...
#  Aug 29, 2019 06:05:25 AM IST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 1385x947+223+59
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    scale $site_6_0.sca43 \
        ...
        -command AxialScroll -font TkDefaultFont \
    ...
    radiobutton $site_4_0.rad51 \
        ...
        -highlightcolor black -justify left -text FlairView 
    vTcl:DefineAlias "$site_4_0.rad51" "FlairView" vTcl:WidgetProc "DeepBrainSeg" 1
    radiobutton $site_4_0.rad52 \
        ...
        -text T1View 
    vTcl:DefineAlias "$site_4_0.rad52" "T1View" vTcl:WidgetProc "DeepBrainSeg" 1
    radiobutton $site_4_0.rad54 \
        -background $vTcl(actual_gui_bg) -command T1ceView \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -justify left -text T1ceView 
    vTcl:DefineAlias "$site_4_0.rad54" "T1ceView" vTcl:WidgetProc "DeepBrainSeg" 1
    radiobutton $site_4_0.rad55 \
        -background $vTcl(actual_gui_bg) -command T2View -font TkDefaultFont \
        -foreground $vTcl(actual_gui_fg) -highlightcolor black -justify left \
        -text T2View 
    vTcl:DefineAlias "$site_4_0.rad55" "T2View" vTcl:WidgetProc "DeepBrainSeg" 1
    radiobutton $site_4_0.rad56 \
        -background $vTcl(actual_gui_bg) -command SegmentationOverlay \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) \
        -highlightcolor black -justify left -text SegmentationOverlay 
    vTcl:DefineAlias "$site_4_0.rad56" "SegmentationOverlay" vTcl:WidgetProc "DeepBrainSeg" 1
    ...
    place $site_4_0.rad51 \
        -in $site_4_0 -x 90 -y 10 -anchor nw -bordermode ignore 
    place $site_4_0.rad52 \
        -in $site_4_0 -x 340 -y 10 -anchor nw -bordermode ignore 
    place $site_4_0.rad54 \
        -in $site_4_0 -x 580 -y 10 -anchor nw -bordermode ignore 
    place $site_4_0.rad55 \
        -in $site_4_0 -x 840 -y 10 -anchor nw -bordermode ignore 
    place $site_4_0.rad56 \
        -in $site_4_0 -x 1090 -y 10 -anchor nw -bordermode ignore 
