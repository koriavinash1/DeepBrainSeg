...
#    Aug 29, 2019 06:05:29 AM IST  platform: Linux
...
class DeepBrainSeg:
    def __init__(self, top=None):
        ...
        top.geometry("1385x947+223+59")
        top.title("New Toplevel")
        top.configure(highlightcolor="black")

        self.Frame1 = tk.Frame(top)
        self.Frame1.place(relx=0.007, rely=0.169, relheight=0.818
                , relwidth=0.986)
        ...
        self.Scale1.place(relx=0.871, rely=0.025, relwidth=0.0, relheight=0.937
                , width=46, bordermode='ignore')
        self.Scale1.configure(command=DeepBrainSeg1_support.AxialScroll)
        self.Scale1.configure(length="366")
        ...
        self.FlairView = tk.Radiobutton(self.Frame2)
        self.FlairView.place(relx=0.067, rely=0.022, relheight=0.037
                , relwidth=0.065)
        self.FlairView.configure(command=DeepBrainSeg1_support.FlairView)
        self.FlairView.configure(justify='left')
        self.FlairView.configure(text='''FlairView''')
        self.FlairView.configure(variable=DeepBrainSeg1_support.selectedButton)

        self.T1View = tk.Radiobutton(self.Frame2)
        self.T1View.place(relx=0.253, rely=0.022, relheight=0.037
                , relwidth=0.049)
        self.T1View.configure(command=DeepBrainSeg1_support.T1View)
        self.T1View.configure(justify='left')
        self.T1View.configure(text='''T1View''')
        self.T1View.configure(variable=DeepBrainSeg1_support.selectedButton)

        self.T1ceView = tk.Radiobutton(self.Frame2)
        self.T1ceView.place(relx=0.431, rely=0.022, relheight=0.037
                , relwidth=0.059)
        self.T1ceView.configure(command=DeepBrainSeg1_support.T1ceView)
        self.T1ceView.configure(justify='left')
        self.T1ceView.configure(text='''T1ceView''')
        self.T1ceView.configure(variable=DeepBrainSeg1_support.selectedButton)

        self.T2View = tk.Radiobutton(self.Frame2)
        self.T2View.place(relx=0.625, rely=0.022, relheight=0.037
                , relwidth=0.049)
        self.T2View.configure(command=DeepBrainSeg1_support.T2View)
        self.T2View.configure(justify='left')
        self.T2View.configure(text='''T2View''')
        self.T2View.configure(variable=DeepBrainSeg1_support.selectedButton)

        self.SegmentationOverlay = tk.Radiobutton(self.Frame2)
        self.SegmentationOverlay.place(relx=0.81, rely=0.022, relheight=0.037
                , relwidth=0.117)
        self.SegmentationOverlay.configure(command=DeepBrainSeg1_support.SegmentationOverlay)
        self.SegmentationOverlay.configure(justify='left')
        self.SegmentationOverlay.configure(text='''SegmentationOverlay''')
        self.SegmentationOverlay.configure(variable=DeepBrainSeg1_support.selectedButton)
        ...
        self.LogoCanvas.place(relx=0.007, rely=0.021, relheight=0.138
                , relwidth=0.983)
