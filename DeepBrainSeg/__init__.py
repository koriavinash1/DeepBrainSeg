...
from src.Tester import DeepBrainSeg
...
if not os.path.exists(model_path):
	...
	print ("[INFO: DeepBrainSeg] (" + time.time() + ")" + 'Tramisu_3D_FC57_best_acc.pth.tar')
	...
	print ("[INFO: DeepBrainSeg] (" + time.time() + ")" + 'Tramisu_2D_FC57_best_loss.pth.tar')
	...
	print ("[INFO: DeepBrainSeg] (" + time.time() + ")" + 'BrainNet_3D_best_acc.pth.tar')
	...
	print ("[INFO: DeepBrainSeg] (" + time.time() + ")" + 'ABL_CE_best_model_loss_based.pth.tar')
	...
	print ("[INFO: DeepBrainSeg] (" + time.time() + ")" + 'Skipping Download Files already exists')